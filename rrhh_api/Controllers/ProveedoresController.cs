...
namespace rrhh_api.Controllers
{
    ...
    public class ProveedoresController : ControllerBase
    {
        ...
        public ProveedoresController(RrhhAdminContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != proveedores.CodProveedor)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Proveedores>> PostProveedores(Proveedores proveedores)
        {
            ...
            {
                if (ProveedoresExists(proveedores.CodProveedor))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetProveedores", new { id = proveedores.CodProveedor }, proveedores);
        }
        ...
        {
            return _context.Proveedores.Any(e => e.CodProveedor == id);
        }
    }
}
